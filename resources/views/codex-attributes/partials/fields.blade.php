    ...
    <div class="mt-2 space-y-2">
        @foreach ($types as $type)
            <label class="flex items-center gap-2">
                <input type="checkbox" name="applies_to[]" value="{{ $type->value }}" @checked(in_array($type->value, $selectedTypes)) class="rounded-sm border-gray-300 text-ocean-600 focus:ring-ocean-500">
