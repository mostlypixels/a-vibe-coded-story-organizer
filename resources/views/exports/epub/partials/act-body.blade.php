{{-- The inner body of an Act divider: "Act {number}" plus the Act's name on its own
     ...
     $number is the project-wide, gap-free rank from App\Support\StoryNumbering — NOT the
     Act's `position` column (see EpubExporter::actViewData()).
