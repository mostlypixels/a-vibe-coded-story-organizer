...
@php
    ...
    // tinted panel, `<status>-surface-content` the text on it, and `<status>`
    // itself the solid fill — used here for the border and the icon, the two
    // places an alert should read as its status colour. The text never sits on
    // `<status>`: that value is chosen to carry white, and as text on the tint it
    // measures as low as 1.85:1.
    $variants = [
        'info' => [
