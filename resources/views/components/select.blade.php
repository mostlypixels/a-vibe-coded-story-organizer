...
{{--
    ...
    `bg-surface-raised` is new here — see <x-text-input> for why.
--}}
<select @disabled($disabled) {{ $attributes->merge(['class' => 'bg-surface-raised border-border-strong focus:border-focus focus:ring-focus rounded-md shadow-xs']) }}>
    {{ $slot }}
</select>
