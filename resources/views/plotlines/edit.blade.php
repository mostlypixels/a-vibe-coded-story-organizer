            ...
            <x-card>
                <form method="POST" action="{{ route('plotlines.update', $plotline) }}" class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea id="description" name="description" rows="4" class="mt-1 block w-full border-gray-300 focus:border-ocean-500 focus:ring-ocean-500 rounded-md shadow-sm">{{ old('description', $plotline->description) }}</textarea>
