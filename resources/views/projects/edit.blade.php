        ...
        <x-card :title="__('Book metadata')">
            ...
            <div class="mt-4 space-y-6">
                <div>
                    ...
                    <select id="language" name="language" form="project-edit-form" class="mt-1 block w-full border-gray-300 focus:border-ocean-500 focus:ring-ocean-500 rounded-md shadow-2xs" required>
            ...
            <x-card :title="$coverUrl ? __('Replace cover image') : __('Cover image')">
                @if ($coverUrl)
                    ...
                    <label class="mt-2 flex items-center gap-2 text-sm text-gray-600">
                        <input type="checkbox" name="remove_cover_image" value="1" form="project-edit-form" class="rounded-xs border-gray-300 text-ocean-600 focus:ring-ocean-500">
