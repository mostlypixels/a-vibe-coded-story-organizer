...
class MelusineSeederIt extends Seeder
{
    ...
    public function run(): void
    {
        ...
        if ($user->projects()->where('name', 'Il Romanzo di Melusina')->exists()) {
            return;
        }
        ...
        foreach ([
            ['title' => 'Inizio', 'event_datetime' => '0980-01-01 00:00:00'],
            ['title' => 'Fine', 'event_datetime' => '1250-12-31 23:59:00'],
        ] as $bookend) {
        ...
        $this->seedChallenges($project, 'Il mese scorso', 'Questo mese');
